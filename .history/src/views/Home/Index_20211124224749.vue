<template>
  <div class="home-page-wrapper">
      ...
      <div class="ft-desc-wrapper">
        <div class="ft-desc-item page-main-width">
          ...
          <div class="ft-desc-label">
            <img
              class="home-page-img-2"
              src="~img/home-page-img-2.png"
              :alt="$t('home.img-alt-1')"
            />
            <div class="ft-desc">
              <div>
        ...
        <div class="ft-desc-item ft-desc-how-work page-main-width">
          ...
          <div class="ft-desc-label">
            ...
            <img
              class="home-page-img-3"
              src="~img/home-page-img-3.png"
              :alt="$t('home.img-alt-2')"
            />
          </div>
        </div>
      </div>
      <div class="select-airport-wrapper" v-if="airportList.length > 0">
        ...
        <div class="page-main-width">
          ...
          <div class="airport-list">
            <div
              class="airport-item"
              v-for="(item, index) in airportList.slice(0, 6)"
              :key="index"
            ...
            >
              ...
              <div class="airport-pic-wrapper">
                <img
                  :src="item.imgUrl || airportImgDefault"
                  :alt="`${item.name}, ${item.iataCode}`"
                  @error="imgError(item)"
                />
                <div
                  class="can-i-use-entitlement"
    ...
    <div class="accept-cookie-wrapper" v-show="!acceptCookie">
      <img
        class="close-accept-cookie"
        src="~img/icon-close.svg"
        alt=""
        @click="handleCloseAcceptCookie"
      />
      <div class="page-main-width">
