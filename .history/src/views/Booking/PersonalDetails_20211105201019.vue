<template>
  <div>
    <div class="bg" v-show="!showAreaCodeList">
      ...
      <ProgressBar
        :thisStep="$t('product.personal-details')"
        :nextStep="$t('product.next-review')"
        rate="50"
        :circleText="$t('product.2-of-4')"
        class="h5Bar"
      />
                  ...
                  <div class="codeInput" :class="{ error: phonePrefixErr }">
                    ...
                    >
                      ...
                      <input
                        ...
                        ref="phonePrefixInput"
                        @keyup="searchAreaCodeResult"
                        @focus="whenFocusPhonePrefixInput"
                      />
                    </div>
                    <div class="select-list" v-show="showSelect">
                      <ul>
                        <li
                          ...
                          v-for="(item, index) in searchResultAreaList"
                          :key="index"
                        >
    ...
    <AreaCodeList
      v-show="showAreaCodeList"
      @close="closeAreaCodeList"
      height="100%"
      :list="areaList"
    />
  </div>
