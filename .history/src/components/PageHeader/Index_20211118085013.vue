<template>
    <div class='page-header-wrapper' :class="{
      ...
      'page-header-wrapper-home': routeName === 'Home',
        ...
        <div class='page-header-content clearfix'>
            ...
            <div class='content-r'>
                ...
                <van-popover v-model='showLanguagePopover' trigger='click' @select='handleLanguagePopoverClick'
                    :offset='[-70, 10]' get-container='getContainer' class='lang-popover'>
                    <div class='popover-item' v-for='_ in languageOpts' :key='_.shortName' @click='selctLang(_)'>
                        <div class=''>
                            <span :class="{
                  ...
                  'el-font': _.acceptLang === 'el-GR',
                        ...
                        <img class='' src='~img/ticked-box-checked.png' alt='' v-if='$i18n.locale === _.acceptLang' />
                    </div>
                    <template #reference>
                ...
                <van-popover v-model='showPopover' trigger='click' @select='handlePopoverClick' :offset='[-20, 10]'
                    get-container='getContainer' v-if='isLogin' class='user-popover'>
        ...
        <van-popup v-model='showNavMenu' position='right' class='nav-menu-wrapper'>
            ...
            <div class='nav-item nav-item-select' @click='clickLanguageSelect'>
                ...
                <div class='language-select-r'>
                    ...
                    <img class='arrow' :class="{ 'arrow-up': showLanguageSelect }" src='~img/icon-down-arrow-black.svg'
                        alt='' />
                </div>
            </div>
            <div class='language-select-box' v-show='showLanguageSelect'>
                <div class='language-item' :class="{ 'fs-bold': $i18n.locale === _.acceptLang }"
                    v-for='_ in languageOpts' :key='_.shortName' @click='selctLang(_)'>
                    <div class=''>
            ...
            <div class='nav-item nav-item-select' v-if='isLogin' @click='clickAccountSelect'>
                ...
                <div class='language-select-r'>
                    ...
                    <img class='arrow' :class="{ 'arrow-up': showAccountSelect }" src='~img/icon-down-arrow-black.svg'
                        alt='' />
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        selctLang(_) {
            ...
            this.setState({ state: 'lang', value: _.acceptLang })
            location.reload();
        },
