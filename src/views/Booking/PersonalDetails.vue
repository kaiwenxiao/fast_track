  ...
  export default {
    ...
    methods: {
      ...
      whenFocusPhonePrefixInput() {
        ...
        if (!this.phonePrefix) {
          // 还原Vue data的某个属性
          this.searchResultAreaList = this.areaList;
          // Object.assign(this.$data.searchResultAreaList,this.$options.data().searchResultAreaList)
        }
      },
      ...
      //   Promise.all([this.$http.booking.getAreas(), this.$http.account
      //     .getAccountInfo({
      //       bookingProcess: 1,
